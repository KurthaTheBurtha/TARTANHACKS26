      ...
      <div className="flex-1 relative bg-muted">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            ...
            <button className="mt-4 inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-secondary hover:bg-secondary/90 text-secondary-foreground font-semibold transition-colors shadow-card">
              ...
              return (
                <div className="bg-card rounded-xl border border-border shadow-xl p-5">
                  ...
                  <div className="flex gap-3">
                    <button className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-border bg-card hover:bg-muted transition-colors text-foreground font-medium">
                      <Phone className="w-4 h-4" />
                      Call
                    </button>
                    <button className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-secondary hover:bg-secondary/90 text-secondary-foreground font-medium transition-colors">
                      <Navigation className="w-4 h-4" />
                      Directions
                    </button>
                  </div>
