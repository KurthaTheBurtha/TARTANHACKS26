  ...
  return (
    <div className="p-6 lg:p-8 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <button className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-secondary hover:bg-secondary/90 text-secondary-foreground font-semibold transition-colors shadow-card">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {upcomingAppointments.map((apt) => (
                <div key={apt.id} className="p-5">
                  ...
                  <div className="flex gap-3">
                    <button className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-border bg-card hover:bg-muted transition-colors text-foreground text-sm font-medium">
                      Reschedule
                    </button>
                    <button className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-border bg-card hover:bg-muted transition-colors text-foreground text-sm font-medium">
                    ...
                    <button className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-secondary hover:bg-secondary/90 text-secondary-foreground text-sm font-medium transition-colors">
        ...
        <div className="space-y-6">
            ...
            <div className="divide-y divide-border">
              {preventiveCare.map((item, i) => (
                <div key={i} className="px-5 py-3 flex items-center justify-between">
                  ...
                  {item.status === 'due' && (
                    <button className="px-3 py-1.5 rounded-lg border border-border bg-card hover:bg-muted transition-colors text-foreground text-sm font-medium">
                      Schedule
                    </button>
                  )}
          ...
          <div className="bg-hero-gradient rounded-xl p-5 text-primary-foreground">
            <h3 className="font-display font-semibold mb-2">Before Your Visit</h3>
            ...
            <button className="mt-4 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-secondary hover:bg-secondary/90 text-secondary-foreground text-sm font-semibold transition-colors">
              Get AI Prep Summary
            </button>
          </div>
        </div>
